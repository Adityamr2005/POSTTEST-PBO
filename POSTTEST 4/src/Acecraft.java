public class Acecraft {
    ...
    // Versi standar: Input String nama server
    public void setServer(String server) {
        if(server.isEmpty()) System.out.println("Server tidak boleh kosong");
        else this.server = server;
    }

    // Versi Overload: Input Integer sebagai kode wilayah (misal: 1 = Asia, 2 = Europe)
    ...
    // --- POLYMORPHISM: METHOD OVERRIDE (Parent Method) ---
